...
def bfs_goal_on_generate(
    ...
    """
    BFS phien ban ket thuc khi sinh ra goal:
    - Lay state ra khoi queue de mo rong.
    ...
    while queue:
        ...
        # Khac BFS binh thuong: neu next_state la goal thi ket thuc ngay tai day.
                ...
                if next_state == goal_state:
                    ...
                    steps.append(
                        SearchStep(
                            ...
                            found=True,
                            path=path,
                            message="BFS ket thuc ngay khi sinh ra state moi la goal.",
                        )
                    )
                    return steps
        ...
        steps.append(
            SearchStep(
                ...
                found=False,
                path=None,
                message="Sinh state moi va dua vao queue vi chua gap goal.",
            )
        )
        expanded_count += 1
...
if __name__ == "__main__":
    ...
    result = bfs_goal_on_generate("A", "G", lambda state: graph[state])
    for step in result:
        print(step)
